...
docs/agents/
  ...
  server.md               ← Nitro BFF routes & auth
  components.md           ← Vue components & pages
...
4. **Human docs stay separate** — `README.md` and `doc/` are for humans; `docs/agents/` is for coding agents.
