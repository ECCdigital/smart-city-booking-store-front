...
function showDate() {
    ...
    if (startDate && endDate && startDate === endDate && startTime && endTime) {
      ...
      return (
          ...
          ", " +
          new Date(startDate + " " + startTime).toLocaleTimeString([], { timeStyle: "short" }) +
          " - " +
          new Date(endDate + " " + endTime).toLocaleTimeString([], { timeStyle: "short" })
      );
    } else {
      // Unterschiedliche Daten
      return (
          new Date(startDate + " " + startTime).toLocaleString([], { dateStyle: "short", timeStyle: "short" }) +
          (endDate && endTime
              ? " - " +
              new Date(endDate + " " + endTime).toLocaleString([], { dateStyle: "short", timeStyle: "short" })
              : "")
      );
    }
}
