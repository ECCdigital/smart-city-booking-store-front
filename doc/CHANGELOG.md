...
- **DEV-805:** Checkout coupon discount no longer applied twice — prices from the validate API are used as-is, with the original price shown struck through when a voucher reduces the line total
